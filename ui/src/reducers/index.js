...
import {SET_SUBTITLE_QUERY, SET_SUBTITLE_PAGE, REQUEST_SEARCH_RESULTS, RECEIVE_SEARCH_RESULTS} from '../actions'
...
const rootReducer = combineReducers({searchQuery, searchPage, searchResultsByQuery});
